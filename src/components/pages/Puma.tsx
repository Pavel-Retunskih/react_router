...
import puma_1 from "../../assets/puma_1.jpg";
import puma_2 from "../../assets/puma_2.jpg";
import puma_3 from "../../assets/puma_3.webp";
...
export const pumaData: PumaItemType[] = [
  { id: 0, model: "Puma Adiform TRXN", collection: "2022", price: "140 $", picture: puma_1 },
  { id: 1, model: "Puma Adiform ISL", collection: "2021", price: "170 $", picture: puma_2 },
  { id: 2, model: "Puma AdiBest XNSP", collection: "2023", price: "120 $", picture: puma_3 },
];
