...
import abibas_1 from "../../assets/abibas_1.webp";
import abibas_2 from "../../assets/abibas_2.jpg";
import abibas_3 from "../../assets/abibas_3.jpg";
export type AbibasItemType = {
  id: number;
  model: string;
  collection: string;
  price: string;
...
export const abibasData: AbibasItemType[] = [
  { id: 0, model: "Adidas Adiform TRXN", collection: "2022", price: "140 $", picture: abibas_1 },
  { id: 1, model: "Adidas Adiform ISL", collection: "2021", price: "170 $", picture: abibas_2 },
  { id: 2, model: "Adidas AdiBest XNSP", collection: "2023", price: "120 $", picture: abibas_3 },
];
